...
이 프로젝트의 목표는 사용자가 데이터를 생성, 조회, 업데이트, 삭제할 수 있는 기본적이면서도 기능적인 선박 운항 데이터 관리 서비스(Ship-ODMS)를 구축하는 것입니다. API 우선 접근 방식을 통해 웹 또는 모바일 프론트엔드의 백엔드로 사용할 수 있도록 합니다.
...
* **데이터 목록 조회**
  ...
  * **GET** `/api/posts`
  * 사용자 스토리: 사용자로서, 모든 최근 데이터를 보고 싶습니다.

* **데이터 생성**

  * **POST** `/api/posts`
  * 필수: `shipid`, `data`
  * 사용자 스토리: 사용자로서, 새 데이터를 생성하고 싶습니다.

* **단일 데이터 조회**

  * **GET** `/api/posts/{postId}`
  * 사용자 스토리: 사용자로서, 특정 데이터를 자세히 읽고 싶습니다.

* **데이터 업데이트**

  * **PATCH** `/api/posts/{postId}`
  * 필수: `shipid`, `data`
  * 사용자 스토리: 사용자로서, 데이터를 업데이트하고 싶습니다.

* **데이터 삭제**

  * **DELETE** `/api/posts/{postId}`
  * 사용자 스토리: 사용자로서, 데이터를 삭제하고 싶습니다.
