...
1. 아래와 같은 프롬프트를 사용하여 React 웹 앱 프로젝트를 스캐폴드하세요.
    ...
    - 초기화할 때 프로젝트 이름으로 `ship-odms`을 사용하세요.
    - 포트 번호는 `3000`을 사용하세요.
...
1. [Figma 디자인 템플릿](https://www.figma.com/community/file/1121837397555194172)을 계정에 복사하세요.

   ![Figma design template page](./images/javascript-01.png)
   ![Figma design template page](./images/javascript-02.png)

1. 각 섹션 - `Table`, `...`을 마우스 우클릭 👉 `Copy/Paste as` 선택 👉 `Copy link to selection` 선택하여 각 섹션의 링크를 가져오세요. 링크를 모두 메모해 두세요.
...
1. 나머지의 Figma 디자인 링크에 대해 계속 더 반복하세요.
1. GitHub Copilot의 ![the "keep" button image](https://img.shields.io/badge/keep-blue) 버튼을 클릭하여 변경사항을 적용하세요.
